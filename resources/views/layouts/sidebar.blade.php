...
<aside id="sidebar"
    class="fixed left-0 top-0 z-99999 flex h-screen w-[290px] -translate-x-full flex-col border-r border-gray-200 bg-white px-5 text-gray-900 dark:border-gray-800 dark:bg-gray-900 xl:translate-x-0"
    x-data="{
        openSubmenus: {},
        init() {
