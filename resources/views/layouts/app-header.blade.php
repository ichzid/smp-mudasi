<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <!-- Logo (mobile only) -->
            <a href="/" class="xl:hidden flex items-center gap-2 min-w-0" aria-label="SMP Muhammadiyah Danau Sijabut">
                <span class="flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-white p-1 shadow-sm ring-1 ring-gray-200 dark:ring-white/10">
                    <img class="h-full w-full object-contain" src="{{ asset('images/logo/smp_mudasi.png') }}" alt="Logo SMP Muhammadiyah Danau Sijabut" />
                </span>
                <span class="hidden max-w-36 text-xs font-bold leading-tight text-gray-900 sm:block dark:text-white">SMP Muhammadiyah<br>Danau Sijabut</span>
            </a>
