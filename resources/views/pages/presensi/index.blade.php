                    ...
                    <div x-data="{ isOptionSelected: true }" class="relative z-20 bg-transparent">
                        <select id="tahun_ajaran_id" name="tahun_ajaran_id" 
                            ...
                            @foreach($tahun_ajarans as $ta)
                                <option value="{{ $ta->id }}" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ request('tahun_ajaran_id') == $ta->id || (empty(request('tahun_ajaran_id')) && $ta->is_aktif) ? 'selected' : '' }}>
