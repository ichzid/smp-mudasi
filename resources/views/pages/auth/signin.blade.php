                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            <div class="mb-5 flex items-center gap-3 lg:hidden">
                                <span class="flex size-14 items-center justify-center overflow-hidden">
                                    <img class="h-full w-full object-contain" src="{{ asset('images/logo/smp_mudasi.png') }}" alt="Logo SMP Muhammadiyah Danau Sijabut">
                                </span>
                                <div class="text-sm font-bold leading-tight text-gray-800 dark:text-white">SMP Muhammadiyah<br>Danau Sijabut</div>
                            </div>
                            <h1 class="text-title-sm sm:text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">
                                Masuk
                            </h1>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Masuk untuk mengelola Sistem Presensi Digital.
                            </p>
                        </div>
                        <div>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="space-y-5">
                                    @if ($errors->any())
                                        <div class="rounded-lg bg-error-50 p-3 text-sm text-error-600 dark:bg-error-500/10 dark:text-error-400">{{ $errors->first() }}</div>
                                    @endif
                                    <!-- Username -->
                                    <div>
                                        ...
                                        <input type="text" id="username" name="username" value="{{ old('username') }}" required autofocus autocomplete="username" placeholder="Masukkan username"
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-sm flex-col items-center">
                        <div class="mb-5 flex size-36 items-center justify-center overflow-hidden">
                            <img class="h-full w-full object-contain" src="{{ asset('images/logo/smp_mudasi.png') }}" alt="Logo SMP Muhammadiyah Danau Sijabut">
                        </div>
                        <h2 class="whitespace-nowrap text-center text-2xl font-bold text-white">SMP Muhammadiyah Danau Sijabut</h2>
