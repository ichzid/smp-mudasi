            ...
            <form action="{{ route('master.guru.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nip" name="nip" value="{{ old('nip') }}" placeholder="Biarkan kosong jika non-PNS"
                    ...
                    <div>
                        ...
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select id="jenis_kelamin" name="jenis_kelamin" required
                                ...
                                <option value="L" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('jenis_kelamin') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="P" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('jenis_kelamin') == 'P' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: JPG, JPEG, PNG. Maksimal 2 MB.</p>
                        @error('foto')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
