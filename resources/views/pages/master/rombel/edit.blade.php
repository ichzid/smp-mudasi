...
@section('content')
    <div class="space-y-6">
        ...
        <x-common.page-breadcrumb 
            ...
            pageSubtitle="Perbarui informasi data kelas."
        />
            ...
            <form action="{{ route('master.rombel.update', $rombel->id) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div x-data="{ isOptionSelected: true }" class="relative z-20 bg-transparent">
                            <select id="tingkat" name="tingkat" required
                                ...
                                <option value="7" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('tingkat', $rombel->tingkat) == '7' ? 'selected' : '' }}>Tingkat 7</option>
                                <option value="8" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('tingkat', $rombel->tingkat) == '8' ? 'selected' : '' }}>Tingkat 8</option>
                                <option value="9" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('tingkat', $rombel->tingkat) == '9' ? 'selected' : '' }}>Tingkat 9</option>
                            </select>
                            <span class="pointer-events-none absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                                <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama', $rombel->nama) }}" required maxlength="50" placeholder="Contoh: 7"
